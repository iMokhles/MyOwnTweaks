...
#define HUD_IMAGE_SUCCESS		[UIImage imageWithContentsOfFile:@"/Library/Application Support/InstaOpenIN/InstaOpenIN.bundle/progresshud-success.png"]
#define HUD_IMAGE_ERROR			[UIImage imageWithContentsOfFile:@"/Library/Application Support/InstaOpenIN/InstaOpenIN.bundle/progresshud-error.png"]
