...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        if ([[UIImage class] instancesRespondToSelector:@selector(imageWithRenderingMode:)]) {
            SVProgressHUDSuccessImage = [[UIImage imageWithContentsOfFile:@"/Library/Application Support/InstaOpenIN/InstaOpenIN.bundle/success"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
            SVProgressHUDErrorImage = [[UIImage imageWithContentsOfFile:@"/Library/Application Support/InstaOpenIN/InstaOpenIN.bundle/error"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        } else {
            SVProgressHUDSuccessImage = [UIImage imageWithContentsOfFile:@"/Library/Application Support/InstaOpenIN/InstaOpenIN.bundle/success"];
            SVProgressHUDErrorImage = [UIImage imageWithContentsOfFile:@"/Library/Application Support/InstaOpenIN/InstaOpenIN.bundle/error"];
        }
...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        ...
        maskLayer.contents = (id)[[UIImage imageWithContentsOfFile:@"/Library/Application Support/InstaOpenIN/InstaOpenIN.bundle/angle-mask@2x.png"] CGImage];
